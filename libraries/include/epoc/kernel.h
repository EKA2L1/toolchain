...
/**
 * \brief Send a message to a server through connected session, wait for the message to be completed.
 * 
 * \param session_handle Handle to the session
 * \param opcode         The message opcode
 * \param ipc_args       Pointer to struct e32_ipc_args
 * 
 * \returns Complete code of the message if sending success.
 */
